...
const unsigned int   CBalloonHelp::unDELETE_THIS_ON_CLOSE   = 0x0100;
const unsigned int   CBalloonHelp::unSHOW_CLOSE_BUTTON      = 0x0200;
const unsigned int   CBalloonHelp::unSHOW_INNER_SHADOW      = 0x0400;
const unsigned int   CBalloonHelp::unSHOW_TOPMOST           = 0x0800;
const unsigned int   CBalloonHelp::unDISABLE_FADEIN         = 0x1000;
const unsigned int   CBalloonHelp::unDISABLE_FADEOUT        = 0x2000;
...
m_strContent(""),
m_nMouseMoveTolerance(3),     // TODO: retrieve from system
m_ptMouseOrig(0,0),
m_uCloseState(0),
m_pTitleFont(NULL),
m_pContentFont(NULL),
...
void CBalloonHelp::DrawNonClientArea(CDC* pDC)
{
	...
	if ( m_unOptions & unSHOW_INNER_SHADOW )
	{
		...
		int green = 270 + GetGValue(m_crBackground)/3;
		int blue = 270 + GetBValue(m_crBackground)/3;
...
void CBalloonHelp::DestroyBalloon()
{
	OnDestroy();
}
